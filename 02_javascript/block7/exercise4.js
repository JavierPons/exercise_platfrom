 // Implement a representation of the universe where matter and energy is conserved. To do so implement one object called 
 // Universe 
 // that contains two objects within: Matter and Energy. If matter is destroyed; that is say we call 
 // Universe.Matter.destroy(5), 
 // then the amount of energy in the universe needs to be increased so that if we call Universe.Energy.total() we 
 // should obtain a 
 // total value of energy that has increased +5 compared to the energy value previous to calling Universe.Matter.destroy(5). 
 // Of course the total amount of Matter obtained by calling Universe.Matter.total()has been reduced by 5 compared 
 // to the initial 
 // value.
    ...
    class Universe {
        constructor(matter = 0, energy = 0){
         ...
         addEnergy(amount){
          ...
          energyTotal(){
               return this.energy += this.matter;
          } 
          matterTotal(){
              return this.matter 
          } 
